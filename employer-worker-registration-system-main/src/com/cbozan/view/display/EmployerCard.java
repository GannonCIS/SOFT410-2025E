...
import com.cbozan.util.IconLoader;
...
public class EmployerCard extends JPanel implements ActionListener{
	...
	public EmployerCard() {
		...
		this.add(new JButton() {
			private static final long serialVersionUID = 1L;
			{
				...
				setIcon(IconLoader.load("text_edit.png"));
				...
				addMouseListener(new MouseAdapter() {
					public void mouseClicked(MouseEvent e) {
						if(descriptionTextArea.isEditable()) {
							((JButton)e.getSource()).setIcon(IconLoader.load("text_edit.png"));
							descriptionTextArea.setEditable(false);
							requestFocusInWindow();
						} else if(!descriptionTextArea.getText().equals(INIT_TEXT)) {
								descriptionTextArea.setEditable(true);
								((JButton)e.getSource()).setIcon(IconLoader.load("check.png"));
	...
	public JButton addEditButton(JTextComponent textField, Component nextFocus) {
		JButton editButton = new JButton(IconLoader.load("text_edit.png"));
		...
		editButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(textField.isEditable()) {
					editButton.setIcon(IconLoader.load("text_edit.png"));
					...
					if(nextFocus != null) {
						...
						editButton.setIcon(IconLoader.load("check.png"));
				}
	...
	public void setSelectedEmployer(Employer selectedEmployer) {
		...
		for(int i = 2; i < this.getComponentCount(); i += 3) {
			...
			((JButton)this.getComponent(i)).setIcon(IconLoader.load("text_edit.png"));
		}
