...
public class WorkerPaymentPanel extends JPanel implements Observer, FocusListener, ActionListener{
	...
	imageLabel.setIcon(IconLoader.load("new_worker_payment.png"));
	...
	workerSearchImageLabel = new JLabel(IconLoader.load("search_worker.png"));
	...
	jobSearchImageLabel = new JLabel(IconLoader.load("search.png"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		int result = JOptionPane.showOptionDialog(this, pane, "Confirmation", 1, 1, 
			IconLoader.load("accounting_icon_1_32.png"), new Object[] {"SAVE", "CANCEL"}, "CANCEL");
