...
public class Login extends JFrame{
	...
	public Login() {
		...
		super("Login");
		// set application icon using IconLoader (classpath-first, then src/icon fallback)
		setIconImage(IconLoader.load("Login_user_24.png").getImage());
		//setResizable(false);
		setLayout(null);
	...
	private void GUI() {
		...
		// Try classpath resource first, then fall back to file path
		label_icon = new JLabel(IconLoader.load("Login_user_72.png"));
